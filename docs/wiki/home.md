...
- **Runtime:** ASP.NET Core 9 Minimal API, compiled with Native AOT for the release image.
...
- **Topology:** Two API containers behind NGINX `least_conn`, backed by one PostgreSQL 16 container.
...
| Release image is pushed to GHCR | `.github/workflows/main-release.yml` |
